	...
	<div class="container">
		<div class="post_form bg-white rounded border my_content">
			...
			<div class="post_form p-3">
				<div class="post_form">
					<form action="{{route('agent.post.store')}}" class="form" method="post" accept-charset="utf-8" enctype="multipart/form-data" id="form_post">
						{{csrf_field()}}
				...
				<div class="posting_rule hidden">
					...
					<div>
						<a target="_blank" href="#posting-rule.html">More rules...</a>
					</div>
				</div>
			</div>
		</div>
