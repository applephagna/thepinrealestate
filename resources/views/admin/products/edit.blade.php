    ...
    <div class="col-xs-12">
			<div class="widget-box">
				<div class="widget-header">
					<h4 class="widget-title">Edit Product</h4>
				...
				<div class="widget-body">
					<div class="widget-main no-padding">
						<div class="row spacing-top">
							<form method="POST" action="{{ route('admin.products.update',$product->id) }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
								{{ csrf_field() }}
								{{ method_field('PUT') }}
								@include('admin.products.includes.form',['formMode' => 'edit'])
							</form>
						</div>
					</div>
				</div>
