				...
				<div class="widget-body">
					<div class="widget-main no-padding">
						<div class="row spacing-top">
							<form method="POST" action="{{ route('admin.posts.store') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
								{{ csrf_field() }}	
								@include('posts.includes.form',['formMode' => 'create'])
							</form>
						</div>
					</div>
				</div>
