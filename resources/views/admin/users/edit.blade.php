		...
		<div class="main-content-inner">
			<div class="page-content">
				...
				<div class="row">
						...
						{!! Form::model($row,['route' => ['admin.users.update', $row->id], 'method' => 'POST',
                ...
                <a href="{{ route('admin.users.index') }}" class="btn btn-warning btn-sm"><i class="fa fa-check-square-o"></i> {{ __('Back') }}</a>
				...
				var _token = $('input[name="_token"]').val();
					$.ajax({
						...
						success:function(result){
							...
							$('#referal_user_id').val(result.id);
              $('#referal_user_code').val(result.referal_code);
							if(result=='notfoune'){
								Swal.fire({
									position: 'center',
									type: 'error',
